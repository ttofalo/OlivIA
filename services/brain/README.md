...
2. **Un LLM de nivel 2** (DeepSeek por defecto, cualquier proveedor OpenAI-compatible por configuración) entra cuando Jev duda, cuando la pregunta es abierta o cuando hay que combinar varias acciones.
